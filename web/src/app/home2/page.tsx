...
export default function Home2Page() {
   ...
   return (
      <div className="min-h-screen bg-black text-white selection:bg-blue-500/30">
         ...
         {/* Hero Section with CSS 3D (Instead of R3F VessloText3D) */}
         <section className="h-screen w-full relative overflow-hidden flex flex-col items-center justify-start pt-24">
            ...
            {/* CSS 3D Hero (Instead of Canvas with VessloText3D) */}
            <div className="w-full h-[60vh] relative z-10 pointer-events-none flex flex-col items-center justify-center">
               {/* CSS Glassmorphism Text with Float Animation */}
               <motion.div
               ...
               >
                  <h1
                     ...
                     style={{
                        textShadow: '0 0 80px rgba(59, 130, 246, 0.5), 0 0 40px rgba(255, 255, 255, 0.3)',
               ...
               {/* CSS 3D Cube below text */}
               <div className="w-24 h-24 mt-4 pointer-events-auto">
                  <CSS3DCube iconUrl="/vesslo_icon.png" color="#a855f7" size={80} />
               </div>
            </div>
